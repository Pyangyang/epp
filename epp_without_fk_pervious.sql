...
CREATE TABLE `mb_problem_field` (
  ...
  `problem_field_name` varchar(255) DEFAULT NULL,
...
CREATE TABLE `problem` (
  ...
  `problem_extra_file` varchar(255) DEFAULT NULL,
...
CREATE TABLE `solution` (
  ...
  `solution_extra_file` varchar(255) DEFAULT NULL,
...
CREATE TABLE `team` (
  ...
  `tame_leader` varchar(255) NOT NULL,
